...
samples.file.meta.pre<-read.table("/Users/stevensmith/Documents/School/Maryland/Classes/Comp_Bio_Systems/project/design",sep="\t")
design_table<-with(samples.file.meta.pre,data.frame(V2,V4,V5,V6,V8,V9,V10,row.names=1))
names(design_table)<-c("local_stability","global_stability","infection","activity","subject","class")
save(design_table,file="design_table.Rda")
#Load Ref Genome
